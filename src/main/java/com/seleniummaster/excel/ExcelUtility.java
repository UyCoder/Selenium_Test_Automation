...
public class ExcelUtility {
    ...
    public void writeToExcelFile(String filename,String sheetName,
                                 int rowNumber,int cellNumber,String content)
    {
    ...
    public void writeToExcelFileMultipleCells(String filename, String sheetName,
    ...
    public String readExcelCell(String filename, String sheetName,int rowNumber,int colNumber)
    {
